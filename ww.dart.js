...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _ControllerSubscription$(_controller, onData, onError, onDone, cancelOnError, $T) {
      ...
      return new A._ControllerSubscription(_controller, onData, t1, t2, $T._eval$1("_ControllerSubscription<0>"));
    },
    ...
    callbackToStream(object, $name, unwrapValue, $J, $T) {
      var t1 = $T._eval$1("_SyncBroadcastStreamController<0>"),
        ...
        t2 = object == null ? type$.Object._as(object) : object;
    ...
    NewtonRoot(n, l) {
      var t1, root, t2,
        x = Math.pow(10, B.JSNumber_methods.ceil$0(n.toString$0(0).length / 2));
      for (t1 = type$.BigInt, root = 1; true; x = root) {
        t2 = t1._as(A._BigIntImpl__BigIntImpl$from(x));
        root = 0.5 * (x + n.toDouble$0(0) / t2.toDouble$0(0));
    ...
    main() {
      ...
      worker = A.Worker$();
      possible_endings = A._setArrayType([0, 1, 4, 9, 16, 21, 24, 25, 29, 36, 41, 44, 49, 56, 61, 64, 69, 76, 81, 84, 89, 96], type$.JSArray_int);
      t1 = worker.__Worker__outputController_A;
      t1 === $ && A.throwLateFieldNI("_outputController");
      new A._ControllerStream(t1, A._instanceType(t1)._eval$1("_ControllerStream<1>")).listen$1(new A.main_closure(worker, possible_endings));
    },
    main_closure: function main_closure(t0, t1) {
      this.worker = t0;
      this.possible_endings = t1;
    },
    isBrowserObject(o) {
  ...
  A.Worker.prototype = {
    Worker$0() {
      ...
      A.callbackToStream(self.self, "onmessage", new A.Worker_closure(this), type$.MessageEvent, type$.Null);
    }
  };
  ...
  A.main_closure.prototype = {
    call$1(message) {
      ...
      t2 = data[0];
      result = A._BigIntImpl__tryParse(t2, null);
      if (result == null)
      ...
      for (t1 = type$._BigIntImpl, t2 = this.possible_endings, counts = 0; true;) {
        ...
        t3 = t1._as(A._BigIntImpl__BigIntImpl$from(100));
        if (t3._used === 0)
          A.throwExpression(B.C_IntegerDivisionByZeroException);
        result0 = res._rem$1(t3);
        if (result0._isNegative)
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "js___convertToJS$closure", "_convertToJS", 21);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.FixedLengthListMixin, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.Closure, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A._Required, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A.Stream, A._BufferingStreamSubscription, A._BroadcastStreamController, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamController, A._AsyncStreamControllerDispatch, A._DelayedEvent, A._PendingEvents, A._DoneStreamSubscription, A._Zone, A.ListMixin, A._UnmodifiableMapMixin, A._BigIntImpl, A.DateTime, A.StackOverflowError, A._Exception, A.FormatException, A.IntegerDivisionByZeroException, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.ImmutableListMixin, A.FixedSizeListIterator, A.JsObject, A.Worker]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._SyncBroadcastStreamController__sendData_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._BigIntImpl_hashCode_finish, A._BigIntImpl_toDouble_readBits, A._convertToJS_closure, A._convertToJS_closure0, A._wrapToDart_closure, A._wrapToDart_closure0, A._wrapToDart_closure1, A.callbackToStream_closure, A.Worker_closure, A.main_closure]);
    _inheritMany(A.Closure2Args, [A.Primitives_functionNoSuchMethod_closure, A.initHooks_closure0, A.MapBase_mapToString_closure, A.NoSuchMethodError_toString_closure, A._BigIntImpl_hashCode_combine, A.MidiInputMap_keys_closure, A.MidiOutputMap_keys_closure, A.RtcStatsReport_keys_closure, A.Storage_keys_closure, A.AudioParamMap_keys_closure]);
    ...
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._StreamController__subscribe_closure, A._PendingEvents_schedule_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A._BigIntImpl_toDouble_roundUp]);
...
//# sourceMappingURL=ww.dart.js.map
